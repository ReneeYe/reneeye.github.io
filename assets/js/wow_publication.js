	...
	l.isotope(
		{
			...
			filter: function(){
						let t=$(this),
						i=c?t.text().match(c):!0,o=r?t.is(r):!0;return i&&o
					}
		}
		);
	let e=$(".filter-search").keyup(p(function(){c=new RegExp(e.val(),"gi"),l.isotope()}));
...
function d(){
	...
	r=f(a),
	l.isotope(),
	$(".pubtype-select").val(t)
}

document.addEventListener("DOMContentLoaded",
	function(){
		$(".pub-filters-select")&&d(),$(".js-cite-modal").click(
			function(e){
				e.preventDefault();
				let t=$(this).attr("data-filename"),
				i=$("#modal");
				i.find(".modal-body code").load(t,
					function(o,u,n){
						if(u=="error"){
							let s="Error: ";
							...
							$(".js-download-cite").attr("href",t)}),i.modal("show")
			}),
		$(".js-copy-cite").click(
			function(e){
				e.preventDefault();
